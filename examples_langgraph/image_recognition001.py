...
# image_b64 = load_image("./images/Image1.jpg")
# resp = model.invoke("Which monument is seen in this image?", images=[image_b64])
...
# model.bind(images=[image_b64])
resp = model.invoke("What is in this picture? /Users/bhavikkawli/Documents/git/autogen-assistant/examples_langgraph/images/Image1.jpg")
# resp = model.invoke("What is in this picture? /Users/bhavikkawli/Documents/git/autogen-assistant/examples_langgraph/images/dogs.jpeg")
print(resp)