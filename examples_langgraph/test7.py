...
# model = ChatOllama(model="mistral:7b-instruct-v0.3-q4_K_M",temperature=0,base_url="http://192.168.0.151:11434").bind_tools(tools)
model = ChatOllama(model="mistral:7b-instruct-v0.3-q4_K_M",temperature=0,base_url="http://localhost:9007").bind_tools(tools)
